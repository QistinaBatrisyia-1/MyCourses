...
void displayOutput(double BMR){
    ...
    cout<<"Sedentary: little or no exercise\t\t\t\t"<<(BMR*1.2)<<endl;
    cout<<"Exercise 1-3 times/week\t\t\t\t\t\t"<<(BMR*1.375)<<endl;
    cout<<"Exercise 4-5 times/week\t\t\t\t\t\t"<<(BMR*1.465)<<endl;
    cout<<"Daily exercise or intense exercise for 3-4 times/week\t\t"<<(BMR*1.55)<<endl;
    cout<<"Intense exercise 6-7 times/week\t\t\t\t\t"<<(BMR*1.725)<<endl;
    cout<<"Very intense exercise daily, or physical job\t\t\t" <<(BMR*1.9)<<endl;
    cout<<endl;
