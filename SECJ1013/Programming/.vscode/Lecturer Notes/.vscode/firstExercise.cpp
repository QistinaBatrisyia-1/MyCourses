...
#include <iostream>//We need this processor directive to use cin and cout 
using namespace std;//This namespace tells that we are using standard namespace
...
int main(){
    ...
    cout <<"Enter the first intial of your name: ";
    cin >> lastNameInitial;
